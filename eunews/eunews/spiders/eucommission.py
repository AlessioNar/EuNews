...
class EUCommissionSpider(scrapy.Spider):
    name = "eucommission"
    def __init__(self):
    ...
    def start_requests(self):
        urls = [
            ...
            'https://ec.europa.eu/commission/presscorner/home/en?pagenumber=2#news-block'
        ]
        for url in urls:
    ...
    def parse(self, response):
        ...
        titles = container.xpath("//section/ul/div[@_ngcontent-c1//text()").getall()
